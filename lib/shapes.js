...
class Shape {
    ...
    anchorText() {
        return `<text x="38%" y="38%" dominant-baseline="middle" text-anchor="middle" font-size="500%" font-weight="700"
...
class Triangle extends Shape {
    ...
    renderTriangle() {
        ...
        <polygon points="150,10 10,190 290,190" style="fill:${this.fill};stroke:${this.fill};stroke-width:1" />
        ${super.anchorText()} </svg>`
    }
}
