...
describe('Triangle', () => {
    ...
    test('should render a triangle with the given colors, text, and text alignment', () => {
        const triangle = new Triangle('#ffdea4','Hey','#ffacaa');
        expect(triangle.renderTriangle()).toBe('<svg version="1.1" height="300" width="200" xmlns="http://www.w3.org/2000/svg"><polygon points="100,10 10,190 190,190" style="fill:#ffdea4;stroke:#ffdea4;stroke-width:1"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="60px" font-weight="700" fill="#ffacaa">Hey</text></svg>');
    });
});
describe('Square', () => {
    ...
    test('should render a square with the given colors, text, and text alignment', () => {
        const square = new Square('#ffdea4','Hey','#ffacaa');
        expect(square.renderSquare()).toBe('<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="300" height="300" style="fill:#ffdea4;stroke-width:3;stroke:#ffdea4"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="60px" font-weight="700" fill="#ffacaa">Hey</text> </svg>');
    });
});
